<!DOCTYPE html>
 ...
 <head>
    ...
    <title>Shree Mahavirpuram | Donaters Invoice</title>
 </head>
                                ...
                                <thead>
                                    <tr>
                                        <th style="text-align: center; font-weight: bold;">
                                            <img src="{{asset('assets/header-2.jpg')}}" width="800" height="159">
                                        </th>
                                    </tr>
                                </thead>
                                <tbody style="margin: 20px 0;display: block;">
                                    <tr style="display: block;margin: 10px 0;">
                                        <td style="width: 400px;">
                                            ...
                                            <span style="width:270px;display: inline-block;border-bottom: 2px solid;">#{{sprintf('%02d', $invoicesMasterRes->bill_no);}}.{{sprintf('%02d', $invoicesRes->splitBill_no)}}</span>
                                        </td>
                                        <td style="width: 400px;">
