                                        ...
                                        <li class="invoice-wrap">
                                            ...
                                            <p>#{{sprintf('%02d', $invoicesMasterRes->bill_no);}}.{{sprintf('%02d', $row->splitBill_no)}}</p>
                                                ...
                                                {{$row->amount_in_words}}<br/>
                                                    ...
                                                    Drawn On: {{$row->drawn_on}}<br/>Cheque Amount: {{$row->cheque_amount}}
                                                ...
                                                <table>
                                                    <tbody>
                                                        ...
                                                        @endif	
                                                            <tr>
                                                                <td> Total:</td>
                                                                <td>{{$invoicesMasterRes->total_amount}}</td>
                                                            </tr>	
                                                    </tbody>
                                                </table>
                                                <a class="button" href="{{url('/shreeFoundation/viewInvoice/'. $row->detail_id)}}" rel="bookmark" style="margin-top: 15px;">View Invoice</a>
                                            </div>
                                        </li>
                                        @endforeach
                                    </ol>
