...
class ShreeFoundationController extends Controller
{
    ...
    public function createInvoice(){
        ...
        if($admin_id != ''){
            ...
            return view('shreeTrustInvoice')->with('bill_no',$res);;
        }else{
            return view('login');
        }
    }
    public function mainInvoiceList(){
        $admin_id = session('admin_id');
        if($admin_id != ''){
            $res = InvoiceModel::select('*')->where('trust_id',1)->get();
            return view('shreeTrustDonaterList')->with('mainInvoices',$res);
        }else{
            return view('login');
        }
    ...
    public function detailInvoiceList(Request $request){
        ...
        if($admin_id != ''){
            ...
            return view('shreeTrustDonaterReciepts')->with('invoicesRes',$invoicesRes)->with('invoicesMasterRes',$invoicesMasterRes);
        }else{
            return view('login');
        }
    ...
    public function viewInvoice(Request $request){
        ...
        if($admin_id != ''){
            ...
            $invoicesMasterRes = $invoicesMasterRes[0];
        return view('shreeTrustDonaterInvoice')->with('invoicesRes',$invoicesRes)->with('invoicesMasterRes',$invoicesMasterRes);
        }else{
            return view('login');
        }
